...
以下の点に特に注意してください：
1. 全体的な文章量を増やし、少なくとも5000文字以上の記事にしてください。
2. ユーザーが知りたい情報を網羅的に提供し、詳細な説明を加えてください。
3. 関連するキーワードを自然に目立たず直接的に目立たないように組み込んでください。
4. 適切な見出し構成を使用し、読みやすく整理してください。
5. 元の記事の良い部分は残しつつ、内容を大幅に充実させてください。
6. 具体的な例や実践的なアドバイスを含めてください。
7. 読者が次のアクションを取りたくなるような結論やまとめを含めてください。

改善した記事全文を出力してください。文字数は少なくとも5000文字以上を目指してください。
PROMPT;
    }
